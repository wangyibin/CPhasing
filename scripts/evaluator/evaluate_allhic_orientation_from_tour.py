...
def main(args):
    ...
    pReq.add_argument('clm', help="clm from allhic extract")
    ...
    for contigs in tour_records:
        ...
        for i, contig in enumerate(contigs):
            try:
                ...
                continue
            midpoint_db.append(cum_sum + length)
            cum_sum += length 
