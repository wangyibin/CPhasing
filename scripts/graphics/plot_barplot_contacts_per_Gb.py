...
def main(args):
    ...
    ax = sns.barplot(data=df, x="MapQ", y='Contacts', hue='Library',
    ...
    plt.ylabel("Contacts per Gb (M)", fontsize=16)
    plt.legend(fontsize=12, bbox_to_anchor=(1, 0.5))
    plt.savefig('contacts.per.Gb.barplot.png', dpi=300, bbox_inches='tight')
    plt.savefig('contacts.per.Gb.barplot.pdf', dpi=300, bbox_inches='tight')
